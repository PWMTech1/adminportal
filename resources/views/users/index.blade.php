<x-MainLayout>
    ...
    <div class="contact-container">
        ...
        <div class="contact-header">
            ...
            <div class="contact-actions">
                <a href="/user/create" class="btn-add-contact">
        ...
        <div class="filter-section">
            <form method="POST" action="/user" id="filterForm">
                @csrf()
                <div class="filter-form">
                    ...
                    <div class="filter-group">
                        ...
                        <input type="text" class="filter-input" name="email" id="emailFilter" placeholder="Search by email...">
                    </div>
                    <div class="filter-group">
        ...
        <div class="table-container">
            <div class="table-header">
                <h3 class="table-title">Contact</h3>
            </div>
            ...
            <div id="emptyState" class="empty-state" style="display: none;">
                ...
                <p>Try adjusting your filter criteria or add a new user.</p>
            </div>
        </div>
    ...
    <script>
        ...
        async function loadUsersData(page = 1) {
            try {
                console.log('Loading users data for page:', page);
                ...
                if (data.users && data.users.length > 0) {
                    ...
                    // Always show pagination if we have users
        ...
        function populateUsersTable(users) {
            ...
            users.forEach(user => {
                ...
                row.innerHTML = `
                    ...
                    <td>${user.email}</td>
                    <td>${user.roles ? user.roles.Description : 'No Role'}</td>
                    <td>${user.created_at ? new Date(user.created_at).toLocaleDateString() : 'N/A'}</td>
                    <td>${user.lastlogindate ? new Date(user.lastlogindate).toLocaleDateString() : 'Never'}</td>
                    <td>
                        <div class="action-buttons">
                            ${user.id != {{ auth()->id() }} ? `
                                <a href="/user/${user.id}/edit" class="btn-action btn-edit" title="Edit User">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            ` : `
                                <a href="/profile/edit" class="btn-action btn-edit" title="Edit Profile">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                        <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                    </svg>
