...
<body style="margin: -30px;">
        ...
        <tr>
            ...
            <td style="width:40%; text-align: center;">
                ...
                <div style="font-size:0.85em;">
                    F: 888-972-8596 | T: 303-747-4117 | <a
                        href="mailto:admin@prohealthone.com">admin@prohealthone.com</a>
                </div>
            </td>
            <td style="width:35%;">
                <table style="width: 100%;">
                ...
                <table style="padding-top: 10px;width: 100%; font-size: 10px;" cellspacing="0" cellpadding="0">
                    <tr>
                        <td style="padding-bottom: 5px;">
                            <label>
                                <input type="checkbox" value="Contractures" id="">
                                <div class="label-text fa-lg"><span>Insulin</span></div>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label>
                                <input type="checkbox" value="Contractures" id="">
                                <div class="label-text fa-lg"><span>Oral Hypoglycemic</span></div>
                            </label>
                        </td>
                    </tr>
                    <tr>
        ...
        <tr>
            ...
            <td style="width:25%; border: 1px solid #000;">
                ...
                <table style="width:100%;font-size:10px;">
                    ...
                    <tr>
                        <td colspan="2">
                            Judgement:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$patinfo[0]->Judgement}}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            Compliant:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$patinfo[0]->Compliant}}
                        </td>
                    </tr>
                </table>
            </td>
    ...
    @for($j = 0; $j < count($woundinfo);$j+=4) @if($j==4 || $j==12 || $j==20) <span style='page-break-after: always;'>
        </span>
        <table style='width: 100%;'>
            @include("PartialView.PatientInfo", ['patinfo' => $patinfo])
        </table>
