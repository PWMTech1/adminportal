        ...
        <div class="flex justify-center">
            <div class="w-full block rounded-lg shadow-lg bg-white">
                <div class="py-3 px-6 border-b border-gray-300 bg-indigo-600 text-white">
                    <h5 class="font-bold">Add New Entity</h5>
                </div>
                <form method="POST" action="/ffs/entity/store" autocomplete="off" class="form-horizontal"
                    ...
                    <div class="p-6">
                        <div class="">
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="form-group mb-6">
                                    <label class="text-gray-900 text-sm font-medium mb-2">Entity</label>
                                    <input name="entity" id="entity" type="text" placeholder="{{ __('Entity') }}" value=""
                                        required aria-required="true"
                                        class="form-control block w-full px-3 py-1.5 text-base
                                    font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300
                                    rounded transition ease-in-out m-0 datepicker
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="form-group mb-6">
                                    <label class="text-gray-900 text-sm font-medium mb-2">State</label>
