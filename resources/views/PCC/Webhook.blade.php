                    ...
                    <div class="card">
                        <div class="card-header bg-primary">
                            <div class="float-left">
                              <h4 class="text-white ">{{ __('PointClickCare Webhooks') }}</h4>
                            </div>
                        </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{\Carbon\Carbon::parse($e->EventDate)->format('m/d/Y h:m:s A')}}
                                            </td>
                                            <td>
                                                {{$e->Processed}}
                                            </td>
                                            <td class="text-right">
                                                {{\Carbon\Carbon::parse($e->ProcessedDate)->format('m/d/Y h:m:s A')}}
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
